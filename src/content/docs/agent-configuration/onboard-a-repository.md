...
- [Rules Configuration](/agent-configuration/rules/) — `rules.json` reference after onboarding
- [AI Hub Configuration](/agent-configuration/ai-hub-configuration/) — report execution metrics to 99x AI Hub
