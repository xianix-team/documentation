---
title: AI Hub Configuration
description: Send Xianix execution metrics to 99x AI Hub with raise-events — create a token, copy the webhook URL, and wire rules.json.
---
...
See also: [Rules Configuration](/agent-configuration/rules/) · [Onboard a Repository](/agent-configuration/onboard-a-repository/)
...
![Create personal access token](./img/ai-hub-01-create-personal-access-token.png)
...
![Create team API key](./img/ai-hub-02-create-team-api-key.png)
...
![Create webhook and copy URL](./img/ai-hub-03-create-webhook-copy-url.png)
...
![Add AIHUB-API-KEY secret](./img/ai-hub-04-add-aihub-api-key-secret.png)
